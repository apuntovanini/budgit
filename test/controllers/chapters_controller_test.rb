...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { kind: @chapter.kind, name: @chapter.name, uid: @chapter.uid } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { kind: @chapter.kind, name: @chapter.name, uid: @chapter.uid } }
